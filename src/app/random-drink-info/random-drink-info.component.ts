...
@Component({
  selector: 'app-random-drink-info',
  templateUrl: './random-drink-info.component.html',
  styleUrls: ['./random-drink-info.component.css']
})
export class RandomDrinkInfoComponent implements OnInit {
